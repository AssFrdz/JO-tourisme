...
class ControleurUser
{
    ...
    public function selectClientPro($email)
    {
     ...
     public function insertDesinscriptionClientPro($tab){
        $this->mod->insertDesinscriptionClientPro($tab);
    }

    public function existeDemandeDesinscription($id_user)
    {
        $verif = $this->mod->existeDemandeDesinscription($id_user);
        return $verif;
    }

    public function refusDemandeDesinscription($id_user)
    {
        $verif = $this->mod->refusDemandeDesinscription($id_user);
        return $verif;
    }

    public function getDesinscriptions(){
        $tab = $this->mod->getDesinscriptions();
        return $tab;
    }

    public function supprUser($iduser){
        $this->mod->supprUser($iduser);

    }

    public function refuserDesinscription($id,$motifAdmin){
        $this->mod->refuserDesinscription($id,$motifAdmin);
    }
